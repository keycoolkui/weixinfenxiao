			...
			<div class="clearfix">
				...
				<label class="form-group">
					<div class="col-xs-2">
						...
						<i class="fa fa-check-circle fa-lg text-muted"></i>
					</div>
					<div class="col-xs-10">
						使用账户余额支付
				...
				<label class="form-group">
					<div class="col-xs-2">
						<input type="radio" name="type" value="baifubao">
						<i class="fa fa-check-circle fa-lg text-muted"></i>
					</div>
					<div class="col-xs-10">
						使用百度钱包支付
						<div class="help-block">百度钱包支付</div>
					</div>
				</label>
				<?php  } ?>
			</div>
...
<?php  } ?>
<?php  if($pay['baifubao']['switch']) { ?>
<div class="pay-btn" id="baifubao-panel" style="display:none;">
	<form action="<?php  echo url('mc/cash/baifubao');?>" method="post">
		<input type="hidden" name="params" value="<?php  echo base64_encode(json_encode($params));?>" />
		<input type="hidden" name="encrypt_code" value="" />
		<input type="hidden" name="card_id" value="<?php  echo base64_encode($card_id);?>" />
		<input type="hidden" name="coupon_id" value="" />
		<button class="btn btn-warning btn-block btn-lg" type="submit" name="baifubao">百度钱包支付</button>
	</form>
</div>
<?php  } ?>
