...
<link type="text/css" rel="stylesheet" href="../addons/eso_sale/images/style.css?<?php echo TIMESTAMP;?>">
<div class="head">
...
<form class="form-horizontal" method="post" role="form">
    ...
    <div class="order-main">
        <div id="myaddress">
            ...
            <span><?php  echo $row['province'];?> <?php  echo $row['city'];?> <?php  echo $row['area'];?> <?php  echo $row['address'];?> <br/> <?php  echo $row['realname'];?>, <?php  echo $row['mobile'];?></span><br/>
				<span>
