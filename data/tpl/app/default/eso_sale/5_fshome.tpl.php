...
<div id="beijing">
	...
	<a href="<?php  echo $this->mturl('myfans')?>"><div class="jifen"><?php  if($profile['agent'] == 0 ) { ?>我发展的医生<?php  } else { ?>我发展的会员<?php  } ?><span style="float:right"><?php  echo $count1;?>人</span></div></a>
	...
	<a href="<?php  echo $this->mturl('zhifu')?>"><div class="jifen">打款记录<img src="../addons/eso_sale/style/images/jiantou.png" align="right" /></div></a>
	...
	<div class="ewmform-box">
	  	...
	  	<div class="ewmform-title">扫描二维码绑定医生</div>
		<div class="ewmform-summary"><img class="ewm-thumbnail" id="ewmThumbnail" src="../addons/eso_sale/style/images/share/share<?php  echo $id;?>.png"></div>
	  	<div class="ewmform-des">拿起医生的手机<br>扫描上方二维码</div>
  </div>
</div>
