...
<div class="page-load-page ranking-page"  style="min-height: 771px;">
	...
	<div class="ranking-body" style="padding-top:0px;">
		<div class="ranking-list" >
			<div class="tr">
				<div class="th th1"><?php  if($profile['agent']==0 ) { ?>医生<?php  } else { ?>会员<?php  } ?><span class="arrow arrow-bottom"></span></div>
				<div class="th th2"><?php  if($profile['agent']==0 ) { ?>数量<?php  } else { ?>订单数<?php  } ?><span class="arrow arrow-bottom"></span></div>
				
			</div>
            <?php  if(is_array($list)) { foreach($list as $v) { ?>
            <div class="tr">
                <div class="td r"><?php  echo $v['realname'];?></div>
                <div class="td td2"><a style="color:#FFF" href=""><?php  echo $v['count'];?><?php  if($profile['agent']==0 ) { ?>人数<?php  } else { ?> 订单<?php  } ?></a></div>
            </div>
            <div class="tr">
                <div class="td"></div>
                <div class="td"></div>
		...
		<!--<div style="padding-top:10px;color:#FFF;font-size:1.6em;">说明：您转发的好友（包括下级代理转发）必须首次购买一笔订单，上面的人数才会增加！</div>-->
	</div>
