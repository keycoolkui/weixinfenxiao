...
<div class="main">
	<ul class="nav nav-tabs">
		<li class="active"><a href="./index.php?c=platform&amp;a=reply&amp;m=thinkidea_secondmarket">微人才参数设置</a></li>
	</ul>
    ...
    <form class="form-horizontal form" id="form2" action="" method="post">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <label class="col-sm-4 control-label">职位类型</label>
                <div class="col-sm-4">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
                <label class="col-sm-4 control-label">企业用户是否审核</label>
                <div class="col-sm-4">
                ...
                <em>“是”：通过审核才能发布招聘信息；“否”：无须审核，招聘信息直接通过显示。</em>
            </div>
        </div>
        <div class="panel panel-default">
            <div class="panel-body">
        ...
        <div class="panel panel-default">
            <div class="panel-body">
            	<label class="col-sm-4 control-label">你的联系电话</label>
             	<div class="col-sm-4">
