...
<div id="row" style="margin-top: 20px;">
	...
	<div class="clearfix">
		...
		<div class="col-md-4" style="float: right;margin-top: -55px;">
			<a class="btn btn-success btn-block" href="<?php  echo url('account/bind/post', array('uniacid' => $uniacid));?>"><i class="fa fa-plus"></i> 添加子公众号</a>
		</div>
		<ul class="list-unstyled account">
			<?php  if(is_array($accounts)) { foreach($accounts as $account) { ?>
			<li style="background: #D0DFE5;padding: 5px;border-radius: 3px;margin-bottom: 5px;">
			<div class="row">
				<div class="col-xs-12 col-sm-7 col-md-8 col-lg-9">
					<div class="row">
						...
						<div class="col-xs-12 col-sm-2" style="line-height: 50px;">
				...
				<div class="col-xs-12 col-sm-5 col-md-4 col-lg-3 text-right" style="line-height: 50px;">
