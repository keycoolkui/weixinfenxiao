...
<head>
	...
	<title><?php  if(!empty($_W['page']['title'])) { ?><?php  echo $_W['page']['title'];?> - <?php  } ?><?php  if(empty($_W['page']['copyright']['sitename'])) { ?>微动力 - 公众平台自助引擎1<?php  } else { ?><?php  echo $_W['page']['copyright']['sitename'];?><?php  } ?></title>
		...
		<div class="login-body">
			...
			<form action="" method="post" role="form" class="form-horizontal" onsubmit="return formcheck();">
				...
				<div class="login-subtitle">
					我有帐号！立刻 <a href="<?php  echo url('user/login');?>">登录</a>
				</div>
			</form>
		</div>
		<div class="login-footer">
			<div class="pull-left">
				&copy; 2014 univalsoft.com
			</div>
