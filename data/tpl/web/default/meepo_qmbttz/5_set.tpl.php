<?php defined('IN_IA') or exit('Access Denied');?><?php (!empty($this) && $this instanceof WeModuleSite || 1) ? (include $this->template('common/header3', TEMPLATE_INCLUDEPATH)) : (include template('common/header3', TEMPLATE_INCLUDEPATH));?>
    ...
    <form action="" method="post" class="form-horizontal form">
        ...
        <table class="tb">
            ...
            <tr>
                ...
                <td>
                    ...
                    <input type="text" name="title" class="span5" value="<?php  echo $reply['title']?>" />
		...
		<table>
				...
				<td>
					...
					<textarea style="height:200px; width:100%;" id='share_txt' class="span7 richtext-clone" name="copyright" cols="70"><?php  echo $reply['copyright'];?></textarea>
