		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-9">
						<label class="radio-inline">
							<input type="radio" name="passport[item]" value="mobile" <?php  if($passport['item'] == 'mobile') { ?> checked="checked"<?php  } ?>/> 手机优先
						</label>
						<label class="radio-inline">
							<input type="radio" name="passport[item]" value="email" <?php  if($passport['item'] == 'email' || empty($passport['item'])) { ?> checked="checked"<?php  } ?>/> 邮箱优先
						</label>
						<label class="radio-inline">
			...
			<div class="panel-body">
				<div class="form-group" id="account">
					...
					<div class="col-sm-9">
						...
						<span class="help-block">在微信公众号请求用户网页授权之前，开发者需要先到公众平台网站的【开发者中心】<b>网页服务</b>中配置授权回调域名。<a href="http://www.wdlcms.com/manual/dev:v0.6:qa:mobile_redirect_url_error" target="_black">查看详情</a></span>
					</div>
				</div>
			</div>
		</div>
