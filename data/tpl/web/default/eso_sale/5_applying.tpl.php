...
<ul class="nav nav-tabs">
    <li class="active"><a href="<?php  echo $this->createWebUrl('commission', array('op'=>'display'))?>">佣金申请</a></li>
            ...
            <div class="sub-item" id="table-list">
                ...
                <div class="sub-content">
                    <table class="table table-hover">
                        ...
                        <?php  if(!empty($member['realname'][$v['shareid']]) && !empty($member['mobile'][$v['shareid']])) { ?>
                        <tr>
                            <td>
                            ...
                            <td>
                                <?php  echo date('Y-m-d',$v['applytime'])?>
                            </td>
                            <td>
                                <span class="label label-success">正在申请</span>
                            </td>
                            <td>
                                <a href="<?php  echo $this->createWebUrl('commission',array('op'=>'display', 'opp'=>'check', 'id' => $v['id'], 'shareid'=>$v['shareid']));?>">审核</a>
                            </td>
                        </tr>
                        <?php  } ?>
                        <?php  } } ?>
