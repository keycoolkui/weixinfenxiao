        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" name="express_name" id='express_name' class="form-control" value="<?php  echo $express['express_name'];?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">公司网站</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" id='express_url' name="express_url" class="form-control" value="<?php  echo $express['express_url'];?>" />
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 control-label">配送区域</label>
                    <div class="col-sm-9 col-xs-12">
                        <input type="text" id='express_area' name="express_area" class="form-control" value="<?php  echo $express['express_area'];?>" />
                    </div>
                </div>
            </div>
        </div>
