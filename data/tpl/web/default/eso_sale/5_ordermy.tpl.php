...
<?php  if(empty($shareid)) { ?>
	...
	<li <?php  if($operation == 'display' && $status == '1') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ordermy', array('op' => 'display', 'status' => 1,'uid'=>$_GPC['uid']))?>">待发货</a></li>
	...
	<li <?php  if($operation == 'display' && $status == '0') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ordermy', array('op' => 'display', 'status' => 0,'uid'=>$_GPC['uid']))?>">待付款</a></li>
	<li <?php  if($operation == 'display' && $status == '2') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ordermy', array('op' => 'display', 'status' => 2,'uid'=>$_GPC['uid']))?>">待收货</a></li>
	<li <?php  if($operation == 'display' && $status == '-1') { ?>class="active"<?php  } ?>><a href="<?php  echo $this->createWebUrl('ordermy', array('op' => 'display', 'status' => -1,'uid'=>$_GPC['uid']))?>">全部订单</a></li>
	<?php  } ?>
</ul>
...
<option value="haiwaihuanqiu" data-name="海外刘老太">海外刘老太</option>
